...
@section('content')
    <style>
        ...
        .blog-index .bg-primary,
        .blog-index .badge.bg-primary {
            background-color: var(--primary) !important;
            border-color: var(--primary) !important;
        }

        .blog-index .btn-outline-primary {
            color: var(--primary);
            border-color: var(--primary);
        }

        .blog-index .btn-outline-primary:hover {
            background-color: var(--primary);
            border-color: var(--primary);
            color: white;
        }

        .blog-index .btn-outline-primary.active {
            background-color: var(--primary);
            border-color: var(--primary);
            color: white;
        }

        .blog-index .badge.bg-secondary {
                ...
                <div class="col-md-6 col-lg-4">
                    <article class="card h-100 border-0 shadow-sm">
                        ...
                        <div class="card-footer bg-transparent border-0">
                            <a href="{{ route('blog.show', $post->slug) }}" class="btn btn-outline-primary btn-sm">Read
                                More</a>
                        </div>
                    </article>
                </div>
