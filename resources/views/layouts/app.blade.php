    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <!-- Offcanvas Hamburger Button (visible on mobile) -->
                ...
                <div class="collapse navbar-collapse d-none d-md-flex" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <!-- Add your left nav links here if needed -->
                    </ul>
                ...
                <div class="offcanvas offcanvas-start d-md-none" tabindex="-1" id="mobileOffcanvas" aria-labelledby="mobileOffcanvasLabel">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="mobileOffcanvasLabel">{{ config('app.name', 'Laravel') }}</h5>
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav">
                            ...
                            @else
                                <li class="nav-item dropdown">
                                    <a id="mobileNavbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                        {{ Auth::user()->name }}
                                    </a>
